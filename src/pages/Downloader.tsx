...
export default function Downloader({ downloadState }: DownloaderProps) {
  ...
  // NOTE: Interstitial ad is intentionally NOT shown here.
  // It was incorrectly firing after video INFO is fetched (not after download).
  // The correct place is in DownloadResult.tsx → after the user actually downloads.
  // On native: AdMob interstitial fires in DownloadPlugin.java after download completes.
  // On web: no interstitial — AdSense policy prohibits custom interstitial overlays.
